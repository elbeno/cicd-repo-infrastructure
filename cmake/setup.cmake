...
function(make_gitignore)
    ...
    if(INFRA_USE_SYMLINKS)
        ...
        if(INFRA_PROVIDE_MERMAID_CONFIG)
            if(NOT EXISTS "${CMAKE_SOURCE_DIR}/docs/mermaid.conf")
                list(APPEND GITIGNORE_CONTENTS "/docs/mermaid.conf")
            endif()
        endif()
    endif()
...
if(PROJECT_SOURCE_DIR STREQUAL CMAKE_SOURCE_DIR)
    ...
    if(INFRA_PROVIDE_MERMAID_CONFIG)
        put_in_project_dir("docs/mermaid.conf")
    endif()
